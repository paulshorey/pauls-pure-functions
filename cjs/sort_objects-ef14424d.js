 ...
 */
function _sort_objects_by_property_and_position (arr, rating_key, multiply_position = 1, immutable=false) {
  if (!arr) return []
  if (immutable) arr = [...arr];
  let that = {};
...
let sort_objects_by_property$1 = sort_objects_by_property;
let sort_objects_by_property_and_position = _sort_objects_by_property_and_position;
...
var sort_objects = /*#__PURE__*/Object.freeze({
  __proto__: null,
  sort_objects_by_property: sort_objects_by_property$1,
  sort_objects_by_property_and_position: sort_objects_by_property_and_position
});

exports.sort_objects = sort_objects;
exports.sort_objects_by_property = sort_objects_by_property$1;
