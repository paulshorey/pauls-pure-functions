 ...
 */
const obj_is_equal = function obj_is_equal(obj1, obj2) {
 ...
 * @returns {object}
 */
const obj_from_array = function obj_from_array(arr, default_value=true) {
  let obj = {};
  for (let key of arr) {
...
if (typeof window === 'object') {
  ...
  window.ppf['objects'] = exports__default['default'];
}

var objects = /*#__PURE__*/Object.freeze({
  __proto__: null,
  obj_is_equal: obj_is_equal,
  obj_from_array: obj_from_array,
...
exports.obj_from_array = obj_from_array;
exports.obj_is_empty = obj_is_empty;
exports.obj_is_equal = obj_is_equal;
